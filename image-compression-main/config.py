...
def get_options(parser=argparse.ArgumentParser()):
    ...
    parser.add_argument('--niter', type=int, default=3, help='number of epochs to train for, default=10')
    parser.add_argument('--lr', type=float, default=6e-4, help='select the learning rate, default=3e-5')
